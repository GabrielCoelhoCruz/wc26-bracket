...
export default function DraftPage() {
  ...
  if (!draft) {
    return (
      <div className="flex flex-1 items-center justify-center px-4 py-20 text-[var(--foreground)]">
  ...
  return (
    <div className="flex flex-1 flex-col items-center px-4 py-8 sm:py-12 text-[var(--foreground)]">
      <div className="w-full max-w-4xl">
        ...
        {!draft.completed ? (
          <div className="mx-auto max-w-2xl">
            ...
            <div className="mb-6 h-2 w-full overflow-hidden rounded-full bg-[var(--card-border)]">
              <div
              ...
              {currentPick?.options.map((player) => {
                ...
                return (
                  <button
                    ...
                    className="group flex items-center gap-4 rounded-xl border border-[var(--card-border)] bg-[var(--card-bg)] p-4 text-left transition hover:border-[var(--accent)] hover:shadow-lg"
                  >
                    <span className="flex h-12 w-12 items-center justify-center rounded-full bg-[var(--background)] text-2xl">
                      {getPositionEmoji(player.position)}
                    </span>
                    <div className="flex-1">
                      <div className="font-bold text-white group-hover:text-[var(--accent)]">
                        {player.name}
                      </div>
                      <div className="text-xs opacity-70">
                    ...
                    <div className="text-lg font-black text-[var(--accent)]">{player.rating}</div>
                  </button>
                );
              })}
            </div>
            ...
            <div className="mt-8 flex justify-center">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg border border-[var(--card-border)] px-4 py-2 text-sm font-semibold transition hover:bg-[var(--card-bg)]"
              >
          ...
          <>
            ...
            {match && (
              <div className="mt-8 rounded-2xl border border-[var(--card-border)] bg-[var(--card-bg)] p-6 text-center">
                ...
                <p className="mx-auto mt-3 max-w-md text-sm opacity-80">{matchNarrative(match)}</p>
                ...
                <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
                  ...
                  <button
                    onClick={handleRestart}
                    className="inline-flex items-center gap-2 rounded-lg border border-[var(--card-border)] px-5 py-2.5 text-sm font-semibold transition hover:bg-[var(--background)]"
                  >
  ...
  return (
    <div className="rounded-2xl border border-[var(--card-border)] bg-[var(--card-bg)] p-5">
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="text-lg font-black text-[var(--accent)]">{team.rating}</div>
      </div>
        ...
        {team.players.map((p) => {
          ...
          return (
            <li key={p.id} className="flex items-center gap-3 text-sm">
              ...
              <span className="w-8 text-right font-bold">{p.rating}</span>
            </li>
          );
        })}
      </ul>
